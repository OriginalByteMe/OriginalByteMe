...
export async function fetchColourPalette(track: SpotifyTrack): Promise<SpotifyTrack> {
  if (!track.albumCover) {
...
export async function fetchRecentlyPlayedTracksFromApi(): Promise<SpotifyTrack[]> {
  try {
