...
export default function ChatBox({
  ...
  return (
    <div className="ask-composer">
      <form onSubmit={onSubmit} className="ask-composer__form" aria-busy={loading}>
      ...
      <div className="ask-composer__routes">
        <p className="ask-composer__routes-label">Prompt routes</p>
        <div className="ask-composer__route-list">
          {(mode === "answer" || question) && (
            <button
              type="button"
              aria-label="↺ Home"
              onClick={goHome}
              className="ask-composer__route ask-composer__route--home"
            >
